...
function Scene_Credits(){
	...
	var remixText = new PIXI.Text(textStrings["remixed"], {font: "30px Arial", fill:"#FFFFFF", align: "left"});
	...
	var serverText = new PIXI.Text(textStrings["servered"], {font: "30px Arial", fill:"#FFFFFF", align: "left"});
	...
	var designText = new PIXI.Text(textStrings["designed"], {font: "30px Arial", fill:"#FFFFFF", align: "left"});
    ...
    var supportersText1 = new PIXI.Text(textStrings["patreonSupporters"] + "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nasdfasdfasdfsadfasdfasdfasdfasdf", {font: "40px Arial", fill:"#FFFFFF", align: "left"});
